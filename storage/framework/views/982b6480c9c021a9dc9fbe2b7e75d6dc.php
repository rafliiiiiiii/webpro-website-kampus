  ...
  <body>
    <nav>
      <div class="layar-dalam">
        <div class="logo">
          <a href=""><img src="<?php echo e(asset('image/STTC.png')); ?>" class="putih" /></a>
          <a href=""><img src="<?php echo e(asset(`image/STTC.png`)); ?>" class="hitam" /></a>
        </div>
        <div class="menu">
      ...
      <main>
        ...
        <section class="abuabu" id="support">
          <div class="layar-dalam support">
            <div>
              <img src="<?php echo e(asset('image/Gedung.jpg')); ?>" />
              <h6>Aktivitas</h6>
              <p>
...
</html><?php /**PATH C:\Users\User\Desktop\webkampus-pw\resources\views/welcome.blade.php ENDPATH**/ ?>